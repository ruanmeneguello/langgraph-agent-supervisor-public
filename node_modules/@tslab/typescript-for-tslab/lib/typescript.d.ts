...
declare namespace ts {
    ...
    function getPreEmitDiagnosticsOfFiles(program: Program, sourceFiles: SourceFile[], cancellationToken?: CancellationToken): readonly Diagnostic[];
